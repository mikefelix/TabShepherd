...
(function() {
  var TabShepherd, _, alert, alertText, assertAlert, assertFocus, assertNoOutput, assertOmni, assertText, changeInput, chrome, createTab, currentWindow, defs, enterInput, expectNoResponseFor, expectResponseFor, expectSuggestionFor, focusTab, focusWindow, focusedTabIds, focusedWindowId, idCount, inputChanged, inputEntered, nextId, omniboxText, openTabs, openWindows, reset, suggest, ts, windowRemovedListener, withSavedDef,
