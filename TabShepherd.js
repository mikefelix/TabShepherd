...
(function() {
  ...
  TabShepherd = (function() {
    var Command, commands, storeDefinitions;

    function TabShepherd(chrome) {
      this.withFirstTab = bind(this.withFirstTab, this);
      ...
      this.withEachDefinition = bind(this.withEachDefinition, this);
      this.withWindow = bind(this.withWindow, this);
      this.withEachWindow = bind(this.withEachWindow, this);
      ...
      this.loadDefinitions = bind(this.loadDefinitions, this);
      this.getDefinition = bind(this.getDefinition, this);
      this.deleteDefinition = bind(this.deleteDefinition, this);
      ...
      this.storage.get('windowDefs', (function(_this) {
        return function(data) {
          ...
          return _this.withEachWindow({
            run: function(win) {
              return _this.tabs.getAllInWindow(win.id, function(tabs) {
      ...
      this.windows.onRemoved.addListener((function(_this) {
    ...
    TabShepherd.prototype.makeText = function(arr) {
    ...
    TabShepherd.prototype.getId = function(win) {
    ...
    TabShepherd.prototype.showExamples = function(cmd) {
    ...
    TabShepherd.prototype.summarizeCommands = function(full) {
    ...
    TabShepherd.prototype.loadDefinitions = function(callback) {
    ...
    TabShepherd.prototype.getDefForPattern = function(pattern) {
    ...
    TabShepherd.prototype.unassignPattern = function(pattern, window) {
      var def, i;
      if (window.name == null) {
        alert('Window has no name.');
        return false;
    ...
    TabShepherd.prototype.containsPattern = function(pattern) {
    ...
    TabShepherd.prototype.listPatterns = function(window) {
    ...
    TabShepherd.prototype.withWindowForPattern = function(pattern, callback) {
      var def;
    ...
    TabShepherd.prototype.withTabsMatching = function(patterns, callback) {
      var matches;
      if (!patterns) {
        return callback([]);
      }
    ...
    TabShepherd.prototype.withEachWindow = function(args) {
    ...
    TabShepherd.prototype.withEachDefinition = function(args) {
      var action, condition, finish, reduce;
      condition = args.where || (function(_this) {
        return function() {
          return true;
    ...
    TabShepherd.prototype.withActiveTab = function(callback) {
      return this.tabs.query({
        active: true,
        currentWindow: true
      }, (function(_this) {
    ...
    TabShepherd.prototype.withNewWindow = function(name, callback) {
      var definitions;
    ...
    TabShepherd.prototype.withFirstTab = function(win, callback) {
      return this.tabs.query({
        index: 0,
        windowId: win.id
      }, (function(_this) {
